...
conda install --yes appdirs dask>=1.0 jinja2 numpy pyyaml requests msgpack-numpy pytest fsspec intake-parquet zarr notebook panel==0.5.1 hvplot==0.4.0 -c defaults -c conda-forge
